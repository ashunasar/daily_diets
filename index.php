...
if(isset($_POST['submit'])){
    ...
    if($_GET['title'] == "3-DAYS TRIAL ($33 | 3 MEALS)"){
        $total +=33 * $meal_quantity;
        array_push($data,array("3-DAYS TRIAL ($33 | 3 MEALS)",33,$meal_quantity,33 * $meal_quantity));
    }elseif($_GET['title'] == "Simply Desi ($120 | 20 MEALS)"){
        $total +=120 * $meal_quantity;
        array_push($data,array("Simply Desi ($120 | 20 MEALS)",120,$meal_quantity,120* $meal_quantity));
    }elseif($_GET['title'] == "Lite Meal ($140 | 20 MEALS)"){
        $total +=140 * $meal_quantity;
        array_push($data,array("Lite Meal ($140 | 20 MEALS)",140,$meal_quantity,140 * $meal_quantity));
    }elseif($_GET['title'] == "Healthy Meal ($160 | 20 MEALS)"){
        $total +=160 * $meal_quantity;
        array_push($data,array("Healthy Meal ($160 | 20 MEALS)",160,$meal_quantity,160 * $meal_quantity));
    }elseif($_GET['title'] == "Complete Meal ($200 | 20 MEALS)"){
        $total +=200 * $meal_quantity;
        array_push($data,array("Complete Meal ($200 | 20 MEALS)",200,$meal_quantity,200 * $meal_quantity));
    }elseif($_GET['title'] == "Supreme Meal ($240 | 20 Meal )"){
        $total +=240 * $meal_quantity;
        array_push($data,array("Supreme Meal ($240 | 20 Meal )",240, $meal_quantity,240 * $meal_quantity));
    }elseif($_GET['title'] == "Standard Thali ( $11 )"){
        $total +=11 * $meal_quantity;
        array_push($data,array("Standard Thali ( $11 )",11,$meal_quantity,11 * $meal_quantity));
    }elseif($_GET['title'] == "Premium Thali ( $13 )"){
        $total +=13 * $meal_quantity;
        array_push($data,array("Premium Thali ( $13 )",13,$meal_quantity,13 * $meal_quantity));
    }elseif($_GET['title'] == "Mini Meal ($140 | 20 MEALS)"){
        $total +=140 * $meal_quantity;
        array_push($data,array("Mini Meal ($140 | 20 MEALS)",140,$meal_quantity,140 * $meal_quantity));
    }elseif($_GET['title'] == "1-DAY TRIAL ($12 | 1 MEAL)"){
        $total +=12 * $meal_quantity;
        array_push($data,array("1-DAY TRIAL ($12 | 1 MEAL)",12,$meal_quantity,12 * $meal_quantity));
    }elseif($_GET['title'] == "5-DAYS TRIAL ($50 | 5 MEAL)"){
        $total +=50 * $meal_quantity;
        array_push($data,array("5-DAYS TRIAL ($50 | 5 MEAL)",50,$meal_quantity,50 * $meal_quantity));
    }elseif($_GET['title'] == "12 oz gravy"){
        $total +=8.99 * $meal_quantity;
        array_push($data,array("12 oz gravy",8.99,$meal_quantity,8.99 * $meal_quantity));
    }elseif($_GET['title'] == "16 oz gravy"){
        $total +=10 * $meal_quantity;
        array_push($data,array("16 oz gravy",10,$meal_quantity,10 * $meal_quantity));
    }elseif($_GET['title'] == "24 oz gravy"){
        $total +=15 * $meal_quantity;
        array_push($data,array("24 oz gravy",15,$meal_quantity,15 * $meal_quantity));
    }elseif($_GET['title'] == "Pack of 10 Whole Wheat"){
        $total +=8 * $meal_quantity;
        array_push($data,array("Pack of 10 Whole Wheat",8,$meal_quantity,8 * $meal_quantity));
    }elseif($_GET['title'] == "Pack of 10 Multigrain"){
        $total +=15 * $meal_quantity;
        array_push($data,array("Pack of 10 Multigrain",15,$meal_quantity,15 * $meal_quantity));
    }elseif($_GET['title'] == "Pack of 10 Gluten Free"){
        $total +=22 * $meal_quantity;
        array_push($data,array("Pack of 10 Gluten Free",22,$meal_quantity,22 * $meal_quantity));  
    }elseif($_GET['title'] == "Party of 2"){
        $total +=20 * $meal_quantity;
        array_push($data,array("Party of 2",20,$meal_quantity,20 * $meal_quantity));
    }elseif($_GET['title'] == "Party of 4"){
        $total +=35 * $meal_quantity;
        array_push($data,array("Party of 4",35,$meal_quantity,$meal_quantity));
    }elseif($_GET['title'] == "Party of 8"){
        $total +=64 * $meal_quantity;
        array_push($data,array("Party of 8",64,$meal_quantity,64 * $meal_quantity));
    }elseif($_GET['title'] == "Navratri Fasting Special"){
        $total +=10 * $meal_quantity;
        array_push($data,array("Navratri Fasting Special",10,$meal_quantity,10 * $meal_quantity));
    }else{
    ?>
